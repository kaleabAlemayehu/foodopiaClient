        ...
        <div id="default-carousel" class="relative h-full w-full " data-carousel="slide">
            ...
            <div class="relative h-full overflow-hidden rounded-lg md:h-96">
                ...
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/assets/images/additional1.jpg"
                ...
                <!-- Item 2 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/assets/images/additional2.jpg"
                        class="absolute block w-fit -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                        alt="it doesn't show the image">
                </div>
                <!-- Item 3 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/assets/images/breakfast4.png"
                        class="absolute block w-fit -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                        alt="it doesn't show the image">
                </div>
                <!-- Item 4 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/assets/images/breakfast3.png"
                        class="absolute block w-fit -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                        alt="it doesn't show the image">
                </div>
                <!-- Item 5 -->
                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                    <img src="/assets/images/breakfast5.png"
                        class="absolute block w-fit -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                        alt="it doesn't show the image">
                </div>
            </div>
