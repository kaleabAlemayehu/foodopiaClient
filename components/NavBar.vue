<template>
    <div
        class="sticky top-0 left-0 flex w-screen h-16 bg-customOrang  justify-center items-center max-w-full overflow-hidden flex-1">
        <div class="navContent flex h-full min-w-[90%]  max-w-[90%] justify-between items-center">
            ...
            <div class="intercation flex justify-between w-[30%] items-center">
                <div class="search flex relative top-0 ">
                    ...
                    <input type="search" placeholder="Search Recipe..."
                        class="px-10 py-2 rounded-lg outline-none border-none text-customBlack focus:shadow-sm focus:shadow-customBlack hover:shadow-[] hover:shadow-customBlack transition-all duration-600 "
                        id="searchInput">
                </div>
