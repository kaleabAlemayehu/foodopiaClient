<template>
    <div class=" my-16 py-12 max-w-screen-xl mx-auto px-6">
        <h3 class="text-center  text-2xl ">My Recipes</h3>
        <div class="mt-24">
...
import { GET_MY_RECIPES } from '~/helpers/queries/food';
...
const fetchFood = async () => {
    const { onResult, onError } = useQuery(GET_MY_RECIPES, { offset: offset.value, limit: limit.value, _eq: user.value.id })
    onResult(({ data }) => {
